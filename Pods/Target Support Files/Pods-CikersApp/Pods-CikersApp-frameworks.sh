...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-CikersApp/MBProgressHUD.framework"
  install_framework "Pods-CikersApp/MJRefresh.framework"
  install_framework "Pods-CikersApp/RESideMenu.framework"
